...
import paxi.maokitty.verify.domain.User;
import paxi.maokitty.verify.domain.UserWithDeferObservable;
import paxi.maokitty.verify.domain.UserWithJustObservable;
